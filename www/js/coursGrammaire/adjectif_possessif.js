...
"<td> POSSESSEUR </td>  <td>POSSESSIF</td> <td>POSSESSIF</td> " +
  ...
  "<tr>" +
  "<td> </td>    <td>  SINGULIER </td>                  <td>  PLURIEL </td>" +
  "</tr>"+
  
  "<tr>" +
" <td>SINGULIER </td>	<td>MAS - FEM</td>	 <td>MAS - FEM</td> " +
 "</tr>" +
 
 "<tr>" +
 "   <td> </td>      <td> Mon	/   Ma	 </td>              <td>  Mes  </td> " +
 "</tr>"+
 
  "<tr>" +
 "     <td> </td>     <td> Ton	/   Ta	   </td>             <td>  Tes </td> " +
  "</tr>"+
  
   "<tr>" +
 "  <td> </td>       <td>  Son	/   Sa	  </td>             <td>   Ses  </td> " +
   "</tr>"+
   
   "<tr>" + 
"<td> PLURIEL </td>       <td> MAS - FEM </td>	<td>   MAS - FEM </td> " +
 "</tr>"+
 
  "<tr>" + 
 "  <td> </td>      <td>  Notre	              <td>  Nos </td> " +
  "</tr>"+       
           
  "<tr>" + 
 "   <td> </td>      <td> Votre	             <td>   Vos </td> " +
  "</tr>"+ 
